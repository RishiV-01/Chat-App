...
export default function ConversationList() {
  ...
  return (
    <div className="flex w-[400px] flex-shrink-0 flex-col rounded-xl border border-gray-300">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-full bg-[#1B4D6E] px-4 py-2 text-xs font-semibold text-white transition-colors hover:bg-[#164060]"
        >
